...
RSpec.shared_examples "a_state" do
  ...
  describe "#do" do
    it "takes a move as a parameter and returns the resulting state" do
      ...
      state = described_class.new(pieces: [p1, p2])
  ...
  describe "#in_check?" do
    let(:king) { King.new(team: "white", starting_pos: [1,1]) }
    let(:queen) { Queen.new(team: "black", starting_pos: [1,5]) }

    it "returns true if king is in check" do
      state = described_class.new(pieces: [king, queen])
  ...
  describe "#checkmate?" do
    it "returns true if checkmate" do
      ...
      state = described_class.new(pieces: [king, queen, bishop])
    ...
    it "returns false if king can escape" do
      ...
      state = described_class.new(pieces: [king, rook])
    ...
    it "returns false if ally piece can capture attacker" do
      ...
      state = described_class.new(pieces: [king, pawn, rook, queen])
      expect(state.checkmate?("white")).to be false
    end
  end
end
